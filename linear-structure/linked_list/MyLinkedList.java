...
public class MyLinkedList<T> implements Iterable<T> {
  ...
  ///// Exception /////
  public static class MyLinkedListIndexOutOfBoundsException extends RuntimeException {
  ...
  public static class MyLinkedListIllegalArgumentException extends RuntimeException {

    public MyLinkedListIllegalArgumentException(int fromIndex, int toIndex) {
      super(String.format("fromIndex(%d) > toIndex(%d)", fromIndex, toIndex));
    }
  }
